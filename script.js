//alert('Захист 4 лабороторної роботи')
...
function inputData() {
  ...
  document.getElementById('demo').innerHTML = 'Res: назва: ' + facultyInput + ', телефон: ' + telInput
...
function inputDate() {
  ...
  document.getElementById('dem').innerHTML = 'Res: спеціальність: ' + specInput + ', ширф: ' + shirfInput + ' та кількість студентів: ' + kolStudInput
...
function addData() {
  ...
  document.getElementById('demka').innerHTML = 'Res: змінена спеціальність: ' + group.spec + ', змінений ширф: ' + group.shirf + ' та змінена кількість студентів: ' + group.kolStud
...
function updateData() {
  ...
  document.getElementById('demon').innerHTML = 'Res: замінена спеціальність: ' + group.spec + ', замінений ширф: ' + group.shirf + ' та змінена кількість студентів: ' + group.kolStud
...
function deleteData() {
  ...
  document.getElementById('negr').innerHTML = 'Res: спеціальність: ' + group.spec + ', ширф: ' + group.shirf + ' кількість студентів: ' + group.kolStud
...
function copyData() {
  ...
  document.getElementById('abaldyi').innerHTML = 'Назва факультету: ' + copy.facultyName + ', телефон: ' + copy.facultyTel + ', спеціальність групи: ' + copy.groupSpec + ', ширф: ' + copy.groupShirf + ', кількість студентів: ' + copy.groupKolStud
...
Object.prototype.showData = function () {
  ...
  document.getElementById('niger').innerHTML = 'Res: спеціальність: ' + group.spec + ', ширф: ' + group.shirf + ' кількість студентів: ' + group.kolStud
...
function neVidrahovani() {
  ...
  if (sesia.sesiaVidrahovano > group.kolStud) return alert('Помилка: кількість відрахованих студентів не може бути більша за кількість всіх студентів')
  else {

    const vidsotokNeVidrahovanih = ((sesia.sesiaKolStud - sesia.sesiaVidrahovano) / sesia.sesiaKolStud) * 100

    document.getElementById('svejiy').innerHTML = 'Кількість студентів в групі: ' + sesia.sesiaKolStud + ', кількість відрахованих: ' + sesia.sesiaVidrahovano + ', Відсоток не відрахованих студентів: ' + vidsotokNeVidrahovanih + '%'
...
// const success = {
//   showData: function() {
//     document.getElementById('niger').innerHTML = 'Res: спеціальність: ' + this.sesiaSpec + ', ширф: ' + this.sesiaShirf + ' кількість студентів: ' + this.sesiaKolStud
//     console.log('Show data', this.sesiaSpec + ' ' + this.sesiaShirf + ' ' + this.sesiaKolStud)
//   }
// }
//
// // Переопределение метода "showData" в объекте "Успішність"
// success.showData = function() {
//   document.getElementById('niger').innerHTML = 'Res: спеціальність: ' + this.sesiaSpec + ', ширф: ' + this.sesiaShirf + ', кількість студентів: ' + this.sesiaKolStud
//   console.log('Overridden Show data', this.sesiaSpec + ' ' + this.sesiaShirf + ' ' + this.sesiaKolStud)
// }
...
function allStuds() {
  ...
  document.getElementById('bomj').innerHTML = 'Res: кількість хлопців: ' + group.stydent + ', кількість дівчат: ' + group.stydentka + ', кількість всіх студентів: ' + sessionGroup.allStudent + ' та факультет: ' + group.facultet
